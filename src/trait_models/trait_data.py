...
class TraitMatrix:
    ...
    def get_trait_values(self) -> np.ndarray:
        ...
        Returns:
            Numpy array containing all trait values in order
        """
...
class TraitData:
    ...
    def get_trait_count(self) -> int:
        ...
        Returns:
            Total number of traits in the matrix
        """
    ...
    def get_traits_by_category(self, category: TraitCategory) -> Dict[TraitType, TraitVector]:
        ...
        Returns:
            Dictionary of traits belonging to the specified category
        """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing all trait data and metadata
        """
        return {
...
class TraitDataBuilder:
    ...
    def set_interaction_matrix(self, matrix: np.ndarray) -> 'TraitDataBuilder':
        ...
        Args:
            matrix: NxN numpy array representing trait interactions
    ...
    def build(self) -> TraitData:
        ...
        Returns:
            Complete TraitData object with all accumulated information
        """
